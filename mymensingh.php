	...
	<div class="fullwrap header-bg">
		...
		<div class="wrap">
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">ময়মনসিংহে ভ্রমণের স্থানসমূহ</h2><br>
				
			</div>
			<div class="row-one">
				<div class="col">
					<a href="http://google.com"><img src="img/gallery1.jpg" alt="" /></a>
					<h3></h3>
				</div>
				<div class="col">
		...
		<div class="wrap"> 
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">ময়মনসিংহের হোটেলসমূহ</h2><br>
				
			</div>
			<div class="row-one">
				<div class="col">
					<a href=""><img src="img/gallery1.jpg" alt="" /></a>
					<h3>Hotel Mustafiz International</h3>
				</div>
				<div class="col">
					<a href=""><img src="img/gallery2.jpg" alt="" /></a>
					<h3>Hotel Amir Int.</h3>
				</div>	
				<div class="col">	
					<a href=""><img src="img/gallery3.jpg" alt="" /></a>
					<h3>Moinot Ghat</h3>
