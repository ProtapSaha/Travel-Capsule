	...
	<div class="fullwrap header-bg">
		...
		<div class="wrap">
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">বরিশালে ভ্রমণের স্থানসমূহ</h2><br>
				
			</div>
			<div class="row-one">
				<div class="col">
					<a href="sorupkathi.php"><img src="img/barishal/sorupkathi1.jpg" alt="" /></a>
					<h3>স্বরূপকাঠী</h3>
				</div>
				<div class="col">
		...
		<div class="wrap"> 
			<div class="header-area"> 
				<h2 style="text-align: center;margin-bottom: : 20px; text-transform: capitalize;">বরিশালের হোটেলসমূহ</h2><br>
